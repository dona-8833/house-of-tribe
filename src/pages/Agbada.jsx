...
function Agbada() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        let query = supabase.from("products").select("*").eq("category", "agbada");
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Discover our premium Agbada collection crafted from the finest Aso Oke fabric, blending tradition with elegance.
            </p>
          </div>
