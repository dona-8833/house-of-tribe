...
function Cargo() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        let query = supabase.from("products").select("*").eq("category", "cargo");
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900">
              Cargo Pant Collection
            </h1>
            <p className="text-base md:text-lg text-gray-600">
              Discover our premium Cargo Pant collection, crafted from the finest Aso Oke fabric, blending contemporary style with cultural heritage.
            </p>
          </div>
