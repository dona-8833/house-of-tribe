...
function Bubu() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        let query = supabase.from("products").select("*").eq("category", "bubu");
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900">
              Bubu Gown Collection
            </h1>
            <p className="text-base md:text-lg text-gray-600">
              Discover our premium Bubu Gown collection, crafted from the finest Aso Oke fabric, blending grace with cultural heritage.
            </p>
          </div>
